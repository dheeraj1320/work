try {
  ...
  async function getStepData() {
    ...
    if (input && input.GRID_NAME == 'Test Case Step' && input.IS_UI_ELEMENT_GROUP_STEP == 'No' && input.IS_FUNCTION_STEP == 'Yes') {
      ...
      const testCasefunctionStepAttributeValueQuery = `SELECT :TEST_CASE_STATUS as TEST_CASE_STATUS, :TEST_CASE_OWNER as TEST_CASE_OWNER, tcfs.VIEW_NAVIGATION_STEP_UUID,tcfs.TEST_CASE_VIEW_NAVIGATION_STEP_UUID, TEST_CASE_VIEW_NAVIGATION_STEP_ID, TEST_CASE_VIEW_NAVIGATION_STEP_NAME, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, CURRENT_PAGE_CONTEXT, NEXT_PAGE_CONTEXT, TEST_CASE_VIEW_NAVIGATION_STEP_TYPE, TEST_CASE_VIEW_NAVIGATION_STEP_SEQ_ID, tcfs.TEST_CASE_STEP_UUID, tcfs.FUNCTIONAL_AREA_UUID, tcfsav.FUNCTION_UUID, tcfs.FUNCTION_STEP_UUID, tcfs.VIEW_UUID, TEST_CASE_VIEW_NAVIGATION_STEP_ATTRIBUTE_VALUE_UUID, TEST_CASE_VIEW_NAVIGATION_STEP_ATTRIBUTE_VALUE_ID, STEP_DEFINITION_ATTRIBUTE_UUID, TEST_CASE_VIEW_NAVIGATION_STEP_ATTRIBUTE_DATA AS 'VIEW_NAVIGATION_STEP_ATTRIBUTE_DATA', PRE_DEFINED_VALUES_UUID, SCOPE_VARIABLE_TYPE, SCOPE_VARIABLE_UUID FROM TEST_CASE_VIEW_NAVIGATION_STEP tcfs LEFT JOIN TEST_CASE_VIEW_NAVIGATION_STEP_ATTRIBUTE_VALUE tcfsav ON tcfs.TEST_CASE_VIEW_NAVIGATION_STEP_UUID = tcfsav.TEST_CASE_VIEW_NAVIGATION_STEP_UUID WHERE tcfs.TEST_CASE_STEP_UUID=:TEST_CASE_STEP_UUID AND (tcfs.FUNCTION_UUID IS NOT NULL OR tcfs.FUNCTION_UUID !='') AND (tcfs.FUNCTION_STEP_UUID IS NOT NULL OR tcfs.FUNCTION_STEP_UUID !='') AND tcfs.VIEW_UUID=:VIEW_UUID AND tcfs.FUNCTIONAL_AREA_UUID=:APP_LOGGED_IN_FUNTIONAL_AREA_ID`;
      result = await serviceOrchestrator.selectRecordsUsingQuery('PRIMARYSPRINGFM', testCasefunctionStepAttributeValueQuery, input);
    } else if (input && input.GRID_NAME == 'Function Step' && input.IS_PURE_NAVIGATION_STEP == 'Yes') {
  ...
  function getFunctionDataFromAttributeValue(attributeValueQueryData, stepDefArrributeId) {
    ...
    if (
      ...
      (input.TEST_CASE_GRID_DE == 'DATA_ELEMENT_CHILD_TEST_CASE_STEP' ||
        (input && input.TEST_CASE_GRID == 'PRE_DEFINED_CHILD_TEST_CASE_STEP') ||
        ...
        input.GRID_NAME == 'Test Case Function View Navigation Step' ||
  ...
  async function getAttributeValueDetails(attributeId, type) {
    let query = `SELECT TEST_CASE_STEP_ATTRIBUTE_VALUE_UUID AS ID, TEST_CASE_STEP_ATTRIBUTE_DATA AS NAME,'Test Case' as SOURCE_TYPE,STEP_DEFINITION_ATTRIBUTE_UUID FROM TEST_CASE_STEP_ATTRIBUTE_VALUE WHERE TEST_CASE_STEP_ATTRIBUTE_VALUE_UUID='${attributeId}' UNION SELECT FUNCTION_STEP_ATTRIBUTE_VALUE_UUID AS ID, FUNCTION_STEP_ATTRIBUTE_DATA AS NAME, 'Test Case' as SOURCE_TYPE, STEP_DEFINITION_ATTRIBUTE_UUID FROM FUNCTION_STEP_ATTRIBUTE_VALUE WHERE FUNCTION_STEP_ATTRIBUTE_VALUE_UUID = '${attributeId}'`;
  ...
  if (input && input.FIRST_GRID == 'TEST_CASE_STEP_TAB') {
    ...
    queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
  } else if ((input && input.GRID_NAME == 'Test Case') || (input && input.PARENT_GRID == 'Feature Test Set')) {
    ...
    const selectQuery = `SELECT 'Test Case UI Element Group Step' as SCREEN_NAME, :TEST_CASE_STATUS as TEST_CASE_STATUS, :TEST_CASE_OWNER as TEST_CASE_OWNER, UI_ELEMENT_GROUP_STEP_UUID, UI_ELEMENT_GROUP_STEP_ID, UI_ELEMENT_GROUP_STEP_SEQ_ID,UI_ELEMENT_GROUP_STEP_NAME, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, CURRENT_PAGE_CONTEXT, STEP_TYPE, UI_ELEMENT_GROUP_UUID, FUNCTIONAL_AREA_UUID, 'UI_ELEMENT_GROUP_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'UI_ELEMENT_GROUP_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'UI_ELEMENT_GROUP_STEP_UUID' as PRIMARY_COLUMN_NAME, UI_ELEMENT_GROUP_STEP_UUID as PRIMARY_COLUMN_VALUE, CURRENT_PAGE_CONTEXT as PAGE_NAME, :TEST_CASE_STEP_UUID as TEST_CASE_STEP_UUID,:TEST_CASE_UUID as TEST_CASE_UUID,'TEST_CASE_UI_ELEMENT_GROUP_STEP_ATTRIBUTE_DATA' AS REFERENCE_ATTRIBUTE_DATA FROM UI_ELEMENT_GROUP_STEP WHERE UI_ELEMENT_GROUP_UUID=:UI_ELEMENT_GROUP_UUID and FUNCTIONAL_AREA_UUID=:APP_LOGGED_IN_FUNTIONAL_AREA_ID ORDER BY UI_ELEMENT_GROUP_STEP_SEQ_ID asc`;
    queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
    ...
    const selectQuery = `SELECT  :TEST_SET_UUID AS TEST_SET_UUID, :TEST_CASE_UUID AS TEST_CASE_UUID, :TEST_CASE_STEP_UUID AS TEST_CASE_STEP_UUID, VIEW_NAVIGATION_STEP_UUID, :TEST_CASE_STATUS as TEST_CASE_STATUS, :TEST_CASE_OWNER as TEST_CASE_OWNER, VIEW_NAVIGATION_STEP_ID, VIEW_NAVIGATION_STEP_NAME, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, VIEW_NAVIGATION_STEP_TYPE, VIEW_NAVIGATION_STEP_SEQ_ID, CURRENT_PAGE_CONTEXT, NEXT_PAGE_CONTEXT, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'VIEW_NAVIGATION_STEP_UUID' as PRIMARY_COLUMN_NAME, VIEW_NAVIGATION_STEP_UUID as PRIMARY_COLUMN_VALUE, VIEW_UUID, 'No' as IS_PURE_NAVIGATION_STEP,'TEST_CASE_VIEW_NAVIGATION_STEP_ATTRIBUTE_DATA' as REFERENCE_ATTRIBUTE_DATA FROM VIEW_NAVIGATION_STEP WHERE VIEW_UUID=:VIEW_UUID ORDER BY VIEW_NAVIGATION_STEP_SEQ_ID asc`;
    queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
  } else if (input && input.GRID_NAME == 'Test Case Function View Navigation Step') {
  ...
  for (let data of queryData) {
    if (data && Object.keys(data).length) {
      ...
      data['UI_ELEMENT_VALUE'] = test_data;
