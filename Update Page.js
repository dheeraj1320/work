...
if (input.compositeEntityAction == "Update") {
  ...
  const pageNavigationTestSet = 'SELECT TEST_SET_UUID FROM TEST_SET WHERE PAGE_UUID = :PAGE_UUID AND TEST_SET_TYPE = "UI Locator Verification"';
  ...
  // for Test Set
  let testSetQuery = `SELECT TEST_SET_UUID FROM TEST_SET WHERE PAGE_UUID = :PAGE_UUID and TEST_SET_TYPE = 'UI Locator Verification'`;
  ...
  testSetObj['TEST_SET_TYPE'] = 'UI Locator Verification';
  ...
  // Linking test set to UI Locator Verification Test Suite
  const suiteQuery = `SELECT TEST_SUITE_UUID FROM TEST_SUITE WHERE FUNCTIONAL_AREA_UUID = :APP_LOGGED_IN_FUNTIONAL_AREA_ID AND TEST_SUITE_TYPE = 'UI Locator Verification'`;
