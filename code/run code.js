...
const query = `SELECT tc.TEST_CASE_UUID, TEST_CASE_ID,TEST_CASE_NAME, TEST_SET_UUID,TEST_CASE_STATUS,TEST_CASE_EXECUTON_TYPE FROM TEST_CASE tc,TEST_CASE_REQUIREMENT tcr WHERE tc.TEST_CASE_UUID=tcr.TEST_CASE_UUID and tcr.CONDITION_SATISFACTION_UUID=:CONDITION_SATISFACTION_UUID group by TEST_CASE_ID order by TEST_CASE_ID desc;`
