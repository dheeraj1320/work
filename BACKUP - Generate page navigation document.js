...
try {
  ...
  let functionStepNormalQuery = `SELECT PAGE_ID as 'Test Set ID', VIEW_NAVIGATION_ID as 'Test Case ID', VIEW_NAVIGATION_STEP_ID as 'Test Case Step ID', VIEW_NAVIGATION_STEP_SEQ_ID as 'Test Case Step Seq ID', VIEW_NAVIGATION_STEP_TYPE as 'Test Case Step Type', '' as 'Test Case Step Name', '' as 'Step Definition Template', '' as v1, '' as v2, '' as v3, '' as v4, '' as v5, '' as 'Test Case Sep Group Name', '' as reserved2, ( if( ! isnull(vns.NEXT_PAGE_CONTEXT), ( SELECT PAGE_ID FROM PAGE WHERE PAGE.PAGE_UUID = vns.NEXT_PAGE_CONTEXT ), ( SELECT PAGE_ID FROM PAGE WHERE PAGE.PAGE_UUID = vns.CURRENT_PAGE_CONTEXT ) ) ) as 'Page ID', 'Active' as Status, VIEW_NAVIGATION_STEP_UUID as 'Test Case Step UUID', VIEW_NAVIGATION_STEP_ATTRIBUTE_KEYS as 'ATTRIBUTE_KEYS' FROM VIEW_NAVIGATION_STEP vns, VIEW_NAVIGATION vn, PAGE p WHERE vn.VIEW_NAVIGATION_UUID = vns.VIEW_NAVIGATION_UUID AND vn.PAGE_UUID = p.PAGE_UUID AND vns.FUNCTIONAL_AREA_UUID=:FUNCTIONAL_AREA_UUID AND vn.PAGE_UUID=:PAGE_UUID ORDER BY VIEW_NAVIGATION_STEP_ID, VIEW_NAVIGATION_STEP_SEQ_ID asc`;
