try {
  ...
  if (input && input.FIRST_GRID == 'TEST_CASE_STEP_TAB') {
    ...
    const selectQuery = `SELECT VIEW_UUID, CURRENT_PAGE_CONTEXT as PAGE_NAME, TEST_CASE_FUNCTION_STEP_UUID, TEST_CASE_FUNCTION_STEP_ID, TEST_CASE_FUNCTION_STEP_NAME, IS_PURE_NAVIGATION_STEP, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, CURRENT_PAGE_CONTEXT, NEXT_PAGE_CONTEXT, TEST_CASE_FUNCTION_STEP_TYPE, TEST_CASE_FUNCTION_STEP_SEQ_ID, TEST_CASE_STEP_UUID, AE_INSERT_ID, AE_UPDATE_ID, AE_TRANSACTION_ID, AE_INSERT_TS, AE_UPDATE_TS, FUNCTIONAL_AREA_UUID, FUNCTION_UUID, FUNCTION_STEP_UUID, IS_UI_ELEMENT_GROUP_STEP, 'TEST_CASE_FUNCTION_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'TEST_CASE_FUNCTION_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'TEST_CASE_FUNCTION_STEP_UUID' as PRIMARY_COLUMN_NAME, TEST_CASE_FUNCTION_STEP_UUID as PRIMARY_COLUMN_VALUE, 'Test Case Function Step' as GRID_NAME, 'Test Case Function View Navigation Step' AS NAVIGATION_GRID_NAME FROM TEST_CASE_FUNCTION_STEP WHERE TEST_CASE_STEP_UUID=:TEST_CASE_STEP_UUID and FUNCTIONAL_AREA_UUID=:APP_LOGGED_IN_FUNTIONAL_AREA_ID order by TEST_CASE_FUNCTION_STEP_SEQ_ID asc`;
    queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
            ...
            case '57b76ab3-8112-4343-af0f-49643c808bf7':
              {
                ...
                if (data['IS_PURE_NAVIGATION_STEP'] == 'Yes' && data['VIEW_UUID']) {
                  ...
                  const viewQueryData = await serviceOrchestrator.selectRecordsUsingQuery(
                    'PRIMARYSPRINGFM',
                    viewQuery,
                    input
                  );
