        ...
        for (let codeDesc of stepDefAttributeQueryData) {
            ...
            switch (codeDesc['STEP_DEFINITION_ATTRIBUTE_MASTER_UUID']) {
                ...
                case 'e0568059-ce39-4a69-aadd-6a0dccba696d':
                    input[0]['TIME_INTERVAL'] = !input[0]['TIME_INTERVAL'] && !input[0]['timeIntervalCodeDesc'] ? getDataFromAttributeValue(testCaseStepAttributeValueQueryData, codeDesc['STEP_DEFINITION_ATTRIBUTE_UUID']) : input[0]['TIME_INTERVAL'];
                    break;

                case '9d27f361-ac8b-4673-82fe-66c40b2cb634':
                    input[0]['ATTEMPTS'] = !input[0]['ATTEMPTS'] && !input[0]['attemptsCodeDesc'] ? getDataFromAttributeValue(testCaseStepAttributeValueQueryData, codeDesc['STEP_DEFINITION_ATTRIBUTE_UUID']) : input[0]['ATTEMPTS'];
                    break;
