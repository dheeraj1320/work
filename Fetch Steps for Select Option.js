try {
  ...
  switch (input.CONFIGITEMID_FOR_FORMFIELD) {
    case 'da16bbb0-445a-473a-8e97-87191a48ce8a':
      {
        let selectQuery = `SELECT VIEW_NAVIGATION_STEP_UUID, VIEW_NAVIGATION_STEP_ID, VIEW_NAVIGATION_STEP_NAME, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, 'VIEW_NAVIGATION_STEP' as NEW_STEP_TYPE, VIEW_NAVIGATION_STEP_TYPE, VIEW_NAVIGATION_STEP_SEQ_ID, CURRENT_PAGE_CONTEXT, NEXT_PAGE_CONTEXT, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'VIEW_NAVIGATION_STEP_UUID' as PRIMARY_COLUMN_NAME, VIEW_NAVIGATION_STEP_UUID as PRIMARY_COLUMN_VALUE, VIEW_UUID, 'No' as IS_PURE_NAVIGATION_STEP, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_DATA' as REFERENCE_ATTRIBUTE_DATA FROM VIEW_NAVIGATION_STEP WHERE VIEW_UUID=:VIEW_UUID ORDER BY VIEW_NAVIGATION_STEP_SEQ_ID asc`;
        queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
        queryListMap.push(viewNavigationStepQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
      }
      break;
    case '37da1f60-e953-460a-81b1-466d08d30124':
      {
        let selectQuery = `SELECT VIEW_NAVIGATION_STEP_UUID, VIEW_NAVIGATION_STEP_ID, VIEW_NAVIGATION_STEP_NAME, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, 'VIEW_NAVIGATION_STEP' as NEW_STEP_TYPE,VIEW_NAVIGATION_STEP_TYPE, VIEW_NAVIGATION_STEP_SEQ_ID, CURRENT_PAGE_CONTEXT, NEXT_PAGE_CONTEXT, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'VIEW_NAVIGATION_STEP_UUID' as PRIMARY_COLUMN_NAME, VIEW_NAVIGATION_STEP_UUID as PRIMARY_COLUMN_VALUE, VIEW_UUID, 'No' as IS_PURE_NAVIGATION_STEP, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_DATA' as REFERENCE_ATTRIBUTE_DATA FROM VIEW_NAVIGATION_STEP WHERE VIEW_UUID=:SOURCE_VIEW AND VIEW_NAVIGATION_STEP_SEQ_ID >= :START_STEP ORDER BY VIEW_NAVIGATION_STEP_SEQ_ID asc`;
        queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
        queryListMap.push(viewNavigationStepQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
      }
      break;
    case '55f958e6-da6c-43b2-b9bf-a16ddd21a8fa':
      {
        let selectQuery = `SELECT VIEW_NAVIGATION_STEP_UUID, VIEW_NAVIGATION_STEP_ID, VIEW_NAVIGATION_STEP_NAME, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, 'VIEW_NAVIGATION_STEP' as NEW_STEP_TYPE, VIEW_NAVIGATION_STEP_TYPE, VIEW_NAVIGATION_STEP_SEQ_ID, CURRENT_PAGE_CONTEXT, NEXT_PAGE_CONTEXT, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'VIEW_NAVIGATION_STEP_UUID' as PRIMARY_COLUMN_NAME, VIEW_NAVIGATION_STEP_UUID as PRIMARY_COLUMN_VALUE, VIEW_UUID, 'No' as IS_PURE_NAVIGATION_STEP, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_DATA' as REFERENCE_ATTRIBUTE_DATA FROM VIEW_NAVIGATION_STEP WHERE VIEW_UUID=:VIEW_UUID AND VIEW_NAVIGATION_STEP_SEQ_ID=:VIEW_NAVIGATION_STEP_SEQ_ID ORDER BY VIEW_NAVIGATION_STEP_SEQ_ID asc`;
        queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
        queryListMap.push(viewNavigationStepQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
      }
      break;
    case 'b5226d1b-ead0-4ee6-8e7a-6f231cfea97c':
      {
        let selectQuery = `SELECT VIEW_NAVIGATION_STEP_UUID, VIEW_NAVIGATION_STEP_ID, VIEW_NAVIGATION_STEP_NAME, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, 'VIEW_NAVIGATION_STEP' as NEW_STEP_TYPE,VIEW_NAVIGATION_STEP_TYPE, VIEW_NAVIGATION_STEP_SEQ_ID, CURRENT_PAGE_CONTEXT, NEXT_PAGE_CONTEXT, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'VIEW_NAVIGATION_STEP_UUID' as PRIMARY_COLUMN_NAME, VIEW_NAVIGATION_STEP_UUID as PRIMARY_COLUMN_VALUE, VIEW_UUID, 'No' as IS_PURE_NAVIGATION_STEP, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_DATA' as REFERENCE_ATTRIBUTE_DATA FROM VIEW_NAVIGATION_STEP where VIEW_UUID=:VIEW_UUID and VIEW_NAVIGATION_STEP_SEQ_ID>=:VIEW_NAVIGATION_STEP_SEQ_ID ORDER BY VIEW_NAVIGATION_STEP_SEQ_ID asc`;
        queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
        queryListMap.push(viewNavigationStepQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
      ...
      break;
    case '7d9d34f3-18ee-4359-9fe7-bff99e37d591':
      {
        let selectQuery = `SELECT VIEW_NAVIGATION_STEP_UUID, VIEW_NAVIGATION_STEP_ID, VIEW_NAVIGATION_STEP_NAME, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, 'VIEW_NAVIGATION_STEP' as NEW_STEP_TYPE, VIEW_NAVIGATION_STEP_TYPE, VIEW_NAVIGATION_STEP_SEQ_ID, CURRENT_PAGE_CONTEXT, NEXT_PAGE_CONTEXT, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'VIEW_NAVIGATION_STEP_UUID' as PRIMARY_COLUMN_NAME, VIEW_NAVIGATION_STEP_UUID as PRIMARY_COLUMN_VALUE, VIEW_UUID, 'No' as IS_PURE_NAVIGATION_STEP, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_DATA' as REFERENCE_ATTRIBUTE_DATA FROM VIEW_NAVIGATION_STEP WHERE VIEW_UUID=:VIEW_UUID AND VIEW_NAVIGATION_STEP_SEQ_ID=:VIEW_NAVIGATION_STEP_SEQ_ID ORDER BY VIEW_NAVIGATION_STEP_SEQ_ID asc`;
        queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
        queryListMap.push(viewNavigationStepQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
      ...
      break;
    case '2cb3b275-25fc-4087-8ed4-a913855b546f':
      {
        let selectQuery = `SELECT VIEW_NAVIGATION_STEP_UUID, VIEW_NAVIGATION_STEP_ID, VIEW_NAVIGATION_STEP_NAME, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, 'VIEW_NAVIGATION_STEP' as NEW_STEP_TYPE,VIEW_NAVIGATION_STEP_TYPE, VIEW_NAVIGATION_STEP_SEQ_ID, CURRENT_PAGE_CONTEXT, NEXT_PAGE_CONTEXT, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'VIEW_NAVIGATION_STEP_UUID' as PRIMARY_COLUMN_NAME, VIEW_NAVIGATION_STEP_UUID as PRIMARY_COLUMN_VALUE, VIEW_UUID, 'No' as IS_PURE_NAVIGATION_STEP, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_DATA' as REFERENCE_ATTRIBUTE_DATA FROM VIEW_NAVIGATION_STEP where VIEW_UUID=:VIEW_UUID and VIEW_NAVIGATION_STEP_SEQ_ID>=:VIEW_NAVIGATION_STEP_SEQ_ID ORDER BY VIEW_NAVIGATION_STEP_SEQ_ID asc`;
        queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
        queryListMap.push(viewNavigationStepQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
      ...
      break;
    case '01a39604-a0af-48d4-af39-233f6cc04707':
      {
        let selectQuery = `SELECT VIEW_NAVIGATION_STEP_UUID, VIEW_NAVIGATION_STEP_ID, VIEW_NAVIGATION_STEP_NAME, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID,'VIEW_NAVIGATION_STEP' as NEW_STEP_TYPE, VIEW_NAVIGATION_STEP_TYPE, VIEW_NAVIGATION_STEP_SEQ_ID, CURRENT_PAGE_CONTEXT, NEXT_PAGE_CONTEXT, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'VIEW_NAVIGATION_STEP_UUID' as PRIMARY_COLUMN_NAME, VIEW_NAVIGATION_STEP_UUID as PRIMARY_COLUMN_VALUE, VIEW_UUID, 'No' as IS_PURE_NAVIGATION_STEP, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_DATA' as REFERENCE_ATTRIBUTE_DATA FROM VIEW_NAVIGATION_STEP WHERE VIEW_UUID=:SOURCE_VIEW ORDER BY VIEW_NAVIGATION_STEP_SEQ_ID asc`;
        queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
        queryListMap.push(viewNavigationStepQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
      }
      break;
    case '19301abc-5e89-4d6a-a047-2c9dcbd60f43':
      {
        let selectQuery = `SELECT VIEW_NAVIGATION_STEP_UUID, VIEW_NAVIGATION_STEP_ID, VIEW_NAVIGATION_STEP_NAME, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, 'VIEW_NAVIGATION_STEP' as NEW_STEP_TYPE,VIEW_NAVIGATION_STEP_TYPE, VIEW_NAVIGATION_STEP_SEQ_ID, CURRENT_PAGE_CONTEXT, NEXT_PAGE_CONTEXT, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'VIEW_NAVIGATION_STEP_UUID' as PRIMARY_COLUMN_NAME, VIEW_NAVIGATION_STEP_UUID as PRIMARY_COLUMN_VALUE, VIEW_UUID, 'No' as IS_PURE_NAVIGATION_STEP, 'VIEW_NAVIGATION_STEP_ATTRIBUTE_DATA' as REFERENCE_ATTRIBUTE_DATA FROM VIEW_NAVIGATION_STEP WHERE VIEW_UUID=:DESTINATION_VIEW ORDER BY VIEW_NAVIGATION_STEP_SEQ_ID asc`;
        queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
        queryListMap.push(viewNavigationStepQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
      }
      break;
    case '1a9b1ab6-fa2c-4d9a-aab4-f6e8236e1ca0':
      {
        let selectQuery = `SELECT VIEW_UUID, CURRENT_PAGE_CONTEXT as PAGE_NAME, FUNCTION_STEP_ID, FUNCTION_STEP_NAME, FUNCTION_STEP_UUID, IS_PURE_NAVIGATION_STEP, NEXT_PAGE_CONTEXT, CURRENT_PAGE_CONTEXT, IS_OVERIDE_UI_ELEMENT_VALUE_ALLOWED, IS_UI_ELEMENT_VALUE_ATTRIBUTE_PRESENT, IS_UI_ELEMENT_GROUP_STEP, 'FUNCTION_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'FUNCTION_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'FUNCTION_STEP_UUID' as PRIMARY_COLUMN_NAME, FUNCTION_STEP_UUID as PRIMARY_COLUMN_VALUE,'FUNCTION_STEP' as NEW_STEP_TYPE, 'Function Step' as GRID_NAME, FUNCTION_STEP_TYPE, API_UUID, IS_API_ATTRIBUTE_VALUE_PRESENT, FUNCTION_STEP_SEQ_ID, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID,UI_ELEMENT_GROUP_UUID,FUNCTION_UUID FROM FUNCTION_STEP WHERE FUNCTION_UUID=:FUNCTION_UUID and FUNCTIONAL_AREA_UUID=:APP_LOGGED_IN_FUNTIONAL_AREA_ID ORDER BY FUNCTION_STEP_SEQ_ID asc`;
        queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
        queryListMap.push(functionStepNormalQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
      }
      break;
    case '80add70e-9635-4ece-b64e-0e2a6123c44c':
      {
        if (input.SOURCE_TYPE == 'FUNCTION') {
          let selectQuery = `SELECT VIEW_UUID, CURRENT_PAGE_CONTEXT as PAGE_NAME, FUNCTION_STEP_ID, FUNCTION_STEP_NAME, FUNCTION_STEP_UUID, IS_PURE_NAVIGATION_STEP, NEXT_PAGE_CONTEXT, CURRENT_PAGE_CONTEXT, IS_OVERIDE_UI_ELEMENT_VALUE_ALLOWED, IS_UI_ELEMENT_VALUE_ATTRIBUTE_PRESENT, IS_UI_ELEMENT_GROUP_STEP, 'FUNCTION_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'FUNCTION_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'FUNCTION_STEP_UUID' as PRIMARY_COLUMN_NAME, FUNCTION_STEP_UUID as PRIMARY_COLUMN_VALUE, 'FUNCTION_STEP' as NEW_STEP_TYPE, 'Function Step' as GRID_NAME, FUNCTION_STEP_TYPE, API_UUID, IS_API_ATTRIBUTE_VALUE_PRESENT, FUNCTION_STEP_SEQ_ID, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, UI_ELEMENT_GROUP_UUID, FUNCTION_UUID FROM FUNCTION_STEP WHERE FUNCTION_UUID=:FUNCTION_UUID and FUNCTIONAL_AREA_UUID=:APP_LOGGED_IN_FUNTIONAL_AREA_ID ORDER BY FUNCTION_STEP_SEQ_ID asc`;
          queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
          queryListMap.push(functionStepNormalQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
        } else if (input.SOURCE_TYPE == 'UI_ELEMENT_GROUP') {
          let selectQuery = `SELECT UI_ELEMENT_GROUP_STEP_UUID, UI_ELEMENT_GROUP_STEP_SEQ_ID, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, UI_ELEMENT_GROUP_STEP_NAME, UI_ELEMENT_GROUP_UUID, FUNCTIONAL_AREA_UUID, CURRENT_PAGE_CONTEXT, STEP_TYPE,'UI_ELEMENT_GROUP_STEP' as NEW_STEP_TYPE, 'UI_ELEMENT_GROUP_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'UI_ELEMENT_GROUP_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'UI_ELEMENT_GROUP_STEP_UUID' as PRIMARY_COLUMN_NAME, UI_ELEMENT_GROUP_STEP_UUID as PRIMARY_COLUMN_VALUE FROM UI_ELEMENT_GROUP_STEP WHERE UI_ELEMENT_GROUP_UUID=:UI_ELEMENT_GROUP_UUID and FUNCTIONAL_AREA_UUID=:APP_LOGGED_IN_FUNTIONAL_AREA_ID ORDER BY UI_ELEMENT_GROUP_STEP_SEQ_ID asc`;
          queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
          queryListMap.push(uIElementGroupStepQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
        } else if (input.SOURCE_TYPE == 'TEST_CASE') {
          let selectQuery = `SELECT CURRENT_PAGE_CONTEXT as PAGE_NAME, TEST_CASE_STEP_UUID, TEST_CASE_STEP_ID, TEST_CASE_UUID, TEST_SET_UUID, IS_PURE_NAVIGATION_STEP, AE_TRANSACTION_ID, FUNCTIONAL_AREA_UUID, TEST_CASE_STEP_NAME, CURRENT_PAGE_CONTEXT, PAGE_UUID, VIEW_UUID, PROCESS_UUID, USER_ACTION_UUID, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, TEST_CASE_STEP_SEQ_ID, TEST_CASE_STEP_TYPE, NEXT_PAGE_CONTEXT, IS_UI_ELEMENT_GROUP_STEP, IS_FUNCTION_STEP, 'Test Case Step' as GRID_NAME, 'Test Case View Navigation Step' AS NAVIGATION_GRID_NAME, 'TEST_CASE_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'TEST_CASE_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'TEST_CASE_STEP_UUID' as PRIMARY_COLUMN_NAME, 'TEST_CASE_STEP' as NEW_STEP_TYPE, TEST_CASE_STEP_UUID as PRIMARY_COLUMN_VALUE FROM TEST_CASE_STEP WHERE FUNCTIONAL_AREA_UUID=:APP_LOGGED_IN_FUNTIONAL_AREA_ID and TEST_CASE_UUID=:ORIGINAL_TEST_CASE_UUID order by TEST_CASE_STEP_SEQ_ID asc`;
          queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
          queryListMap.push(testCaseStepNormalQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
        }
      }
      break;
    case '504efd28-1909-4355-bc96-00ad425a4e38':
      {
        if (input.SOURCE_TYPE == 'FUNCTION') {
          let selectQuery = `SELECT VIEW_UUID, CURRENT_PAGE_CONTEXT as PAGE_NAME, FUNCTION_STEP_ID, FUNCTION_STEP_NAME, FUNCTION_STEP_UUID, IS_PURE_NAVIGATION_STEP, NEXT_PAGE_CONTEXT, CURRENT_PAGE_CONTEXT, IS_OVERIDE_UI_ELEMENT_VALUE_ALLOWED, IS_UI_ELEMENT_VALUE_ATTRIBUTE_PRESENT, IS_UI_ELEMENT_GROUP_STEP, 'FUNCTION_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'FUNCTION_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'FUNCTION_STEP_UUID' as PRIMARY_COLUMN_NAME, FUNCTION_STEP_UUID as PRIMARY_COLUMN_VALUE, 'FUNCTION_STEP' as NEW_STEP_TYPE, 'Function Step' as GRID_NAME, FUNCTION_STEP_TYPE, API_UUID, IS_API_ATTRIBUTE_VALUE_PRESENT, FUNCTION_STEP_SEQ_ID, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, UI_ELEMENT_GROUP_UUID, FUNCTION_UUID FROM FUNCTION_STEP WHERE FUNCTION_UUID=:FUNCTION_UUID and FUNCTIONAL_AREA_UUID=:APP_LOGGED_IN_FUNTIONAL_AREA_ID AND FUNCTION_STEP_SEQ_ID >= :START_STEP ORDER BY FUNCTION_STEP_SEQ_ID asc`;
          queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
          queryListMap.push(functionStepNormalQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
        } else if (input.SOURCE_TYPE == 'UI_ELEMENT_GROUP') {
          let selectQuery = `SELECT UI_ELEMENT_GROUP_STEP_UUID, UI_ELEMENT_GROUP_STEP_SEQ_ID, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, UI_ELEMENT_GROUP_STEP_NAME, UI_ELEMENT_GROUP_UUID, FUNCTIONAL_AREA_UUID, CURRENT_PAGE_CONTEXT, STEP_TYPE,'UI_ELEMENT_GROUP_STEP' as NEW_STEP_TYPE, 'UI_ELEMENT_GROUP_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'UI_ELEMENT_GROUP_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'UI_ELEMENT_GROUP_STEP_UUID' as PRIMARY_COLUMN_NAME, UI_ELEMENT_GROUP_STEP_UUID as PRIMARY_COLUMN_VALUE FROM UI_ELEMENT_GROUP_STEP WHERE UI_ELEMENT_GROUP_UUID=:UI_ELEMENT_GROUP_UUID and FUNCTIONAL_AREA_UUID=:APP_LOGGED_IN_FUNTIONAL_AREA_ID AND UI_ELEMENT_GROUP_STEP_SEQ_ID >= :START_STEP ORDER BY UI_ELEMENT_GROUP_STEP_SEQ_ID asc`;
          queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
          queryListMap.push(uIElementGroupStepQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
        } else if (input.SOURCE_TYPE == 'TEST_CASE') {
          let selectQuery = `SELECT CURRENT_PAGE_CONTEXT as PAGE_NAME, TEST_CASE_STEP_UUID, TEST_CASE_STEP_ID, TEST_CASE_UUID, TEST_SET_UUID, IS_PURE_NAVIGATION_STEP, AE_TRANSACTION_ID, FUNCTIONAL_AREA_UUID, TEST_CASE_STEP_NAME, CURRENT_PAGE_CONTEXT, PAGE_UUID, VIEW_UUID, PROCESS_UUID, USER_ACTION_UUID, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, TEST_CASE_STEP_SEQ_ID, TEST_CASE_STEP_TYPE, NEXT_PAGE_CONTEXT, IS_UI_ELEMENT_GROUP_STEP, IS_FUNCTION_STEP, 'Test Case Step' as GRID_NAME, 'Test Case View Navigation Step' AS NAVIGATION_GRID_NAME, 'TEST_CASE_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'TEST_CASE_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'TEST_CASE_STEP_UUID' as PRIMARY_COLUMN_NAME, 'TEST_CASE_STEP' as NEW_STEP_TYPE, TEST_CASE_STEP_UUID as PRIMARY_COLUMN_VALUE FROM TEST_CASE_STEP WHERE FUNCTIONAL_AREA_UUID=:APP_LOGGED_IN_FUNTIONAL_AREA_ID and TEST_CASE_UUID=:ORIGINAL_TEST_CASE_UUID AND TEST_CASE_STEP_SEQ_ID >= :START_STEP order by TEST_CASE_STEP_SEQ_ID asc`;
          queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
          queryListMap.push(testCaseStepNormalQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
        }
      }
      break;
    case '3c055bf0-9c51-4146-9c1c-d00363431de7':
      {
        debugger;
        if (input.DESTINATION_TYPE == 'Test Set') {
          let selectQuery = `SELECT CURRENT_PAGE_CONTEXT as PAGE_NAME, TEST_CASE_STEP_UUID, TEST_CASE_STEP_ID, TEST_CASE_UUID, TEST_SET_UUID, IS_PURE_NAVIGATION_STEP, AE_TRANSACTION_ID, FUNCTIONAL_AREA_UUID, TEST_CASE_STEP_NAME, CURRENT_PAGE_CONTEXT, PAGE_UUID, VIEW_UUID, PROCESS_UUID, USER_ACTION_UUID, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, TEST_CASE_STEP_SEQ_ID, TEST_CASE_STEP_TYPE, NEXT_PAGE_CONTEXT, IS_UI_ELEMENT_GROUP_STEP, IS_FUNCTION_STEP, 'Test Case Step' as GRID_NAME, 'Test Case View Navigation Step' AS NAVIGATION_GRID_NAME, 'TEST_CASE_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'TEST_CASE_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'TEST_CASE_STEP_UUID' as PRIMARY_COLUMN_NAME, 'TEST_CASE_STEP' as NEW_STEP_TYPE, TEST_CASE_STEP_UUID as PRIMARY_COLUMN_VALUE FROM TEST_CASE_STEP WHERE FUNCTIONAL_AREA_UUID=:APP_LOGGED_IN_FUNTIONAL_AREA_ID and TEST_CASE_UUID=:DESTINATION_TEST_CASE order by TEST_CASE_STEP_SEQ_ID asc`;
          queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
          queryListMap.push(testCaseStepNormalQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
        } else if (input.DESTINATION_TYPE === 'Function') {
          let selectQuery = `SELECT VIEW_UUID, CURRENT_PAGE_CONTEXT as PAGE_NAME, FUNCTION_STEP_ID, FUNCTION_STEP_NAME, FUNCTION_STEP_UUID, IS_PURE_NAVIGATION_STEP, NEXT_PAGE_CONTEXT, CURRENT_PAGE_CONTEXT, IS_OVERIDE_UI_ELEMENT_VALUE_ALLOWED, IS_UI_ELEMENT_VALUE_ATTRIBUTE_PRESENT, IS_UI_ELEMENT_GROUP_STEP, 'FUNCTION_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'FUNCTION_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'FUNCTION_STEP_UUID' as PRIMARY_COLUMN_NAME, FUNCTION_STEP_UUID as PRIMARY_COLUMN_VALUE, 'FUNCTION_STEP' as NEW_STEP_TYPE, 'Function Step' as GRID_NAME, FUNCTION_STEP_TYPE, API_UUID, IS_API_ATTRIBUTE_VALUE_PRESENT, FUNCTION_STEP_SEQ_ID, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, UI_ELEMENT_GROUP_UUID, FUNCTION_UUID FROM FUNCTION_STEP WHERE FUNCTION_UUID=:DESTINATION_FUNCTION and FUNCTIONAL_AREA_UUID=:APP_LOGGED_IN_FUNTIONAL_AREA_ID ORDER BY FUNCTION_STEP_SEQ_ID asc`;
          queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
          queryListMap.push(functionStepNormalQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
      ...
      break;
    case '5d7c1c7d-e76d-4821-a2c1-a0c895f24eef':
      {
        let selectQuery = `SELECT CURRENT_PAGE_CONTEXT as PAGE_NAME, TEST_CASE_STEP_UUID, TEST_CASE_STEP_ID, TEST_CASE_UUID, TEST_SET_UUID, IS_PURE_NAVIGATION_STEP, AE_TRANSACTION_ID, FUNCTIONAL_AREA_UUID, TEST_CASE_STEP_NAME, CURRENT_PAGE_CONTEXT, PAGE_UUID, VIEW_UUID, PROCESS_UUID, USER_ACTION_UUID, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, TEST_CASE_STEP_SEQ_ID, TEST_CASE_STEP_TYPE, NEXT_PAGE_CONTEXT, IS_UI_ELEMENT_GROUP_STEP, IS_FUNCTION_STEP, 'Test Case Step' as GRID_NAME, 'Test Case View Navigation Step' AS NAVIGATION_GRID_NAME, 'TEST_CASE_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'TEST_CASE_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'TEST_CASE_STEP_UUID' as PRIMARY_COLUMN_NAME, 'TEST_CASE_STEP' as NEW_STEP_TYPE, TEST_CASE_STEP_UUID as PRIMARY_COLUMN_VALUE FROM TEST_CASE_STEP WHERE FUNCTIONAL_AREA_UUID=:APP_LOGGED_IN_FUNTIONAL_AREA_ID and TEST_CASE_UUID=:TEST_CASE_UUID and TEST_CASE_STEP_SEQ_ID>=:TEST_CASE_STEP_SEQ_ID order by TEST_CASE_STEP_SEQ_ID asc`;
        queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
        queryListMap.push(testCaseStepNormalQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
      }
      break;
    case 'afabe0be-75da-49bb-b29d-dfeb1e387430':
      {
        let selectQuery = `SELECT CURRENT_PAGE_CONTEXT as PAGE_NAME, TEST_CASE_STEP_UUID, TEST_CASE_STEP_ID, TEST_CASE_UUID, TEST_SET_UUID, IS_PURE_NAVIGATION_STEP, AE_TRANSACTION_ID, FUNCTIONAL_AREA_UUID, TEST_CASE_STEP_NAME, CURRENT_PAGE_CONTEXT, PAGE_UUID, VIEW_UUID, PROCESS_UUID, USER_ACTION_UUID, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, TEST_CASE_STEP_SEQ_ID, TEST_CASE_STEP_TYPE, NEXT_PAGE_CONTEXT, IS_UI_ELEMENT_GROUP_STEP, IS_FUNCTION_STEP, 'Test Case Step' as GRID_NAME, 'Test Case View Navigation Step' AS NAVIGATION_GRID_NAME, 'TEST_CASE_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'TEST_CASE_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'TEST_CASE_STEP_UUID' as PRIMARY_COLUMN_NAME, 'TEST_CASE_STEP' as NEW_STEP_TYPE, TEST_CASE_STEP_UUID as PRIMARY_COLUMN_VALUE FROM TEST_CASE_STEP WHERE FUNCTIONAL_AREA_UUID=:APP_LOGGED_IN_FUNTIONAL_AREA_ID and TEST_CASE_UUID=:TEST_CASE_UUID and TEST_CASE_STEP_SEQ_ID=:TEST_CASE_STEP_SEQ_ID order by TEST_CASE_STEP_SEQ_ID asc`;
        queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
        queryListMap.push(testCaseStepNormalQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
      ...
      break;
    case '8a918def-16c4-4990-8ed9-868a57033a28':
      {
        let selectQuery = `SELECT CURRENT_PAGE_CONTEXT as PAGE_NAME, TEST_CASE_STEP_UUID, TEST_CASE_STEP_ID, TEST_CASE_UUID, TEST_SET_UUID, IS_PURE_NAVIGATION_STEP, AE_TRANSACTION_ID, FUNCTIONAL_AREA_UUID, TEST_CASE_STEP_NAME, CURRENT_PAGE_CONTEXT, PAGE_UUID, VIEW_UUID, PROCESS_UUID, USER_ACTION_UUID, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, TEST_CASE_STEP_SEQ_ID, TEST_CASE_STEP_TYPE, NEXT_PAGE_CONTEXT, IS_UI_ELEMENT_GROUP_STEP, IS_FUNCTION_STEP, 'Test Case Step' as GRID_NAME, 'Test Case View Navigation Step' AS NAVIGATION_GRID_NAME, 'TEST_CASE_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'TEST_CASE_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'TEST_CASE_STEP_UUID' as PRIMARY_COLUMN_NAME, 'TEST_CASE_STEP' as NEW_STEP_TYPE, TEST_CASE_STEP_UUID as PRIMARY_COLUMN_VALUE FROM TEST_CASE_STEP WHERE FUNCTIONAL_AREA_UUID=:APP_LOGGED_IN_FUNTIONAL_AREA_ID and TEST_CASE_UUID=:TEST_CASE_UUID order by TEST_CASE_STEP_SEQ_ID asc`;
        queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
        queryListMap.push(testCaseStepNormalQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
      }
      break;
    case 'ed527222-af55-4f20-b3c4-d967afae388d':
      {
        let selectQuery = `SELECT CURRENT_PAGE_CONTEXT as PAGE_NAME, TEST_CASE_STEP_UUID, TEST_CASE_STEP_ID, TEST_CASE_UUID, TEST_SET_UUID, IS_PURE_NAVIGATION_STEP, AE_TRANSACTION_ID, FUNCTIONAL_AREA_UUID, TEST_CASE_STEP_NAME, CURRENT_PAGE_CONTEXT, PAGE_UUID, VIEW_UUID, PROCESS_UUID, USER_ACTION_UUID, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, TEST_CASE_STEP_SEQ_ID, TEST_CASE_STEP_TYPE, NEXT_PAGE_CONTEXT, IS_UI_ELEMENT_GROUP_STEP, IS_FUNCTION_STEP, 'Test Case Step' as GRID_NAME, 'Test Case View Navigation Step' AS NAVIGATION_GRID_NAME, 'TEST_CASE_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'TEST_CASE_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'TEST_CASE_STEP_UUID' as PRIMARY_COLUMN_NAME, 'TEST_CASE_STEP' as NEW_STEP_TYPE, TEST_CASE_STEP_UUID as PRIMARY_COLUMN_VALUE FROM TEST_CASE_STEP WHERE FUNCTIONAL_AREA_UUID=:APP_LOGGED_IN_FUNTIONAL_AREA_ID and TEST_CASE_UUID=:TEST_CASE_UUID AND TEST_CASE_STEP_SEQ_ID>=:TEST_CASE_STEP_SEQ_ID order by TEST_CASE_STEP_SEQ_ID asc`;
        queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
        queryListMap.push(testCaseStepNormalQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
      ...
      break;
    case '6ca91a49-df3f-414c-98fa-77487574f1f5':
      {
        let selectQuery = `SELECT CURRENT_PAGE_CONTEXT as PAGE_NAME, TEST_CASE_STEP_UUID, TEST_CASE_STEP_ID, TEST_CASE_UUID, TEST_SET_UUID, IS_PURE_NAVIGATION_STEP, AE_TRANSACTION_ID, FUNCTIONAL_AREA_UUID, TEST_CASE_STEP_NAME, CURRENT_PAGE_CONTEXT, PAGE_UUID, VIEW_UUID, PROCESS_UUID, USER_ACTION_UUID, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, TEST_CASE_STEP_SEQ_ID, TEST_CASE_STEP_TYPE, NEXT_PAGE_CONTEXT, IS_UI_ELEMENT_GROUP_STEP, IS_FUNCTION_STEP, 'Test Case Step' as GRID_NAME, 'Test Case View Navigation Step' AS NAVIGATION_GRID_NAME, 'TEST_CASE_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'TEST_CASE_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'TEST_CASE_STEP_UUID' as PRIMARY_COLUMN_NAME, 'TEST_CASE_STEP' as NEW_STEP_TYPE, TEST_CASE_STEP_UUID as PRIMARY_COLUMN_VALUE FROM TEST_CASE_STEP WHERE FUNCTIONAL_AREA_UUID=:APP_LOGGED_IN_FUNTIONAL_AREA_ID and TEST_CASE_UUID=:TEST_CASE_UUID AND TEST_CASE_STEP_SEQ_ID >=:START_STEP order by TEST_CASE_STEP_SEQ_ID asc`;
        queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
        queryListMap.push(testCaseStepNormalQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
      ...
      break;
    case '0d14375d-644f-4c26-b0f9-5d3dc1cc503e':
      {
        let selectQuery = `SELECT VIEW_UUID, CURRENT_PAGE_CONTEXT as PAGE_NAME, FUNCTION_STEP_ID, FUNCTION_STEP_NAME, FUNCTION_STEP_UUID, IS_PURE_NAVIGATION_STEP, NEXT_PAGE_CONTEXT, CURRENT_PAGE_CONTEXT, IS_OVERIDE_UI_ELEMENT_VALUE_ALLOWED, IS_UI_ELEMENT_VALUE_ATTRIBUTE_PRESENT, IS_UI_ELEMENT_GROUP_STEP, 'FUNCTION_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'FUNCTION_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'FUNCTION_STEP_UUID' as PRIMARY_COLUMN_NAME, FUNCTION_STEP_UUID as PRIMARY_COLUMN_VALUE, 'FUNCTION_STEP' as NEW_STEP_TYPE, 'Function Step' as GRID_NAME, FUNCTION_STEP_TYPE, API_UUID, IS_API_ATTRIBUTE_VALUE_PRESENT, FUNCTION_STEP_SEQ_ID, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, UI_ELEMENT_GROUP_UUID, FUNCTION_UUID FROM FUNCTION_STEP where FUNCTION_UUID=:FUNCTION_UUID AND FUNCTION_STEP_SEQ_ID=:FUNCTION_STEP_SEQ_ID ORDER BY FUNCTION_STEP_SEQ_ID asc`;
        queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
        queryListMap.push(functionStepNormalQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
      }
      break;
    case '6c79c592-ee27-4f77-9564-3f0251cd774c':
      {
        let selectQuery = `SELECT VIEW_UUID, CURRENT_PAGE_CONTEXT as PAGE_NAME, FUNCTION_STEP_ID, FUNCTION_STEP_NAME, FUNCTION_STEP_UUID, IS_PURE_NAVIGATION_STEP, NEXT_PAGE_CONTEXT, CURRENT_PAGE_CONTEXT, IS_OVERIDE_UI_ELEMENT_VALUE_ALLOWED, IS_UI_ELEMENT_VALUE_ATTRIBUTE_PRESENT, IS_UI_ELEMENT_GROUP_STEP, 'FUNCTION_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'FUNCTION_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'FUNCTION_STEP_UUID' as PRIMARY_COLUMN_NAME, FUNCTION_STEP_UUID as PRIMARY_COLUMN_VALUE, 'FUNCTION_STEP' as NEW_STEP_TYPE, 'Function Step' as GRID_NAME, FUNCTION_STEP_TYPE, API_UUID, IS_API_ATTRIBUTE_VALUE_PRESENT, FUNCTION_STEP_SEQ_ID, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, UI_ELEMENT_GROUP_UUID, FUNCTION_UUID FROM FUNCTION_STEP where FUNCTION_UUID=:FUNCTION_UUID AND FUNCTION_STEP_SEQ_ID>=:FUNCTION_STEP_SEQ_ID ORDER BY FUNCTION_STEP_SEQ_ID asc`;
        queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
        queryListMap.push(functionStepNormalQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
      ...
      break;
    case '096e0d4f-d786-427e-9733-c4b3042d67fd':
      {
        let selectQuery = `SELECT VIEW_UUID, CURRENT_PAGE_CONTEXT as PAGE_NAME, FUNCTION_STEP_ID, FUNCTION_STEP_NAME, FUNCTION_STEP_UUID, IS_PURE_NAVIGATION_STEP, NEXT_PAGE_CONTEXT, CURRENT_PAGE_CONTEXT, IS_OVERIDE_UI_ELEMENT_VALUE_ALLOWED, IS_UI_ELEMENT_VALUE_ATTRIBUTE_PRESENT, IS_UI_ELEMENT_GROUP_STEP, 'FUNCTION_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'FUNCTION_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'FUNCTION_STEP_UUID' as PRIMARY_COLUMN_NAME, FUNCTION_STEP_UUID as PRIMARY_COLUMN_VALUE, 'FUNCTION_STEP' as NEW_STEP_TYPE, 'Function Step' as GRID_NAME, FUNCTION_STEP_TYPE, API_UUID, IS_API_ATTRIBUTE_VALUE_PRESENT, FUNCTION_STEP_SEQ_ID, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, UI_ELEMENT_GROUP_UUID, FUNCTION_UUID FROM FUNCTION_STEP WHERE FUNCTION_UUID=:FUNCTION_UUID and FUNCTIONAL_AREA_UUID=:APP_LOGGED_IN_FUNTIONAL_AREA_ID ORDER BY FUNCTION_STEP_SEQ_ID asc`;
        queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
        queryListMap.push(functionStepNormalQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
      ...
      break;
    case '467234a6-072e-406e-a7a5-0567ee81cced':
      {
        let selectQuery = `SELECT VIEW_UUID, CURRENT_PAGE_CONTEXT as PAGE_NAME, FUNCTION_STEP_ID, FUNCTION_STEP_NAME, FUNCTION_STEP_UUID, IS_PURE_NAVIGATION_STEP, NEXT_PAGE_CONTEXT, CURRENT_PAGE_CONTEXT, IS_OVERIDE_UI_ELEMENT_VALUE_ALLOWED, IS_UI_ELEMENT_VALUE_ATTRIBUTE_PRESENT, IS_UI_ELEMENT_GROUP_STEP, 'FUNCTION_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'FUNCTION_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'FUNCTION_STEP_UUID' as PRIMARY_COLUMN_NAME, FUNCTION_STEP_UUID as PRIMARY_COLUMN_VALUE, 'FUNCTION_STEP' as NEW_STEP_TYPE, 'Function Step' as GRID_NAME, FUNCTION_STEP_TYPE, API_UUID, IS_API_ATTRIBUTE_VALUE_PRESENT, FUNCTION_STEP_SEQ_ID, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, UI_ELEMENT_GROUP_UUID, FUNCTION_UUID FROM FUNCTION_STEP WHERE FUNCTION_UUID=:FUNCTION_UUID and FUNCTIONAL_AREA_UUID=:APP_LOGGED_IN_FUNTIONAL_AREA_ID AND FUNCTION_STEP_SEQ_ID >= :START_STEP ORDER BY FUNCTION_STEP_SEQ_ID asc`;
        queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
        queryListMap.push(functionStepNormalQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
      ...
      break;
    case 'fc0b0eb3-389d-4f66-9870-4953b37b13c3':
      {
        let selectQuery = `SELECT CURRENT_PAGE_CONTEXT as PAGE_NAME, TEST_CASE_STEP_UUID, TEST_CASE_STEP_ID, TEST_CASE_UUID, TEST_SET_UUID, IS_PURE_NAVIGATION_STEP, AE_TRANSACTION_ID, FUNCTIONAL_AREA_UUID, TEST_CASE_STEP_NAME, CURRENT_PAGE_CONTEXT, PAGE_UUID, VIEW_UUID, PROCESS_UUID, USER_ACTION_UUID, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, TEST_CASE_STEP_SEQ_ID, TEST_CASE_STEP_TYPE, NEXT_PAGE_CONTEXT, IS_UI_ELEMENT_GROUP_STEP, IS_FUNCTION_STEP, 'Test Case Step' as GRID_NAME, 'Test Case View Navigation Step' AS NAVIGATION_GRID_NAME, 'TEST_CASE_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'TEST_CASE_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'TEST_CASE_STEP_UUID' as PRIMARY_COLUMN_NAME, 'TEST_CASE_STEP' as NEW_STEP_TYPE, TEST_CASE_STEP_UUID as PRIMARY_COLUMN_VALUE FROM TEST_CASE_STEP WHERE FUNCTIONAL_AREA_UUID=:APP_LOGGED_IN_FUNTIONAL_AREA_ID and TEST_CASE_UUID=:TEST_CASE_UUID order by TEST_CASE_STEP_SEQ_ID asc`;
        queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
        queryListMap.push(testCaseStepNormalQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
      ...
      break;
    case '0435a0aa-cf6e-4fe7-84bf-bd3d8122c8f1':
      {
        let selectQuery = `SELECT CURRENT_PAGE_CONTEXT as PAGE_NAME, TEST_CASE_STEP_UUID, TEST_CASE_STEP_ID, TEST_CASE_UUID, TEST_SET_UUID, IS_PURE_NAVIGATION_STEP, AE_TRANSACTION_ID, FUNCTIONAL_AREA_UUID, TEST_CASE_STEP_NAME, CURRENT_PAGE_CONTEXT, PAGE_UUID, VIEW_UUID, PROCESS_UUID, USER_ACTION_UUID, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, TEST_CASE_STEP_SEQ_ID, TEST_CASE_STEP_TYPE, NEXT_PAGE_CONTEXT, IS_UI_ELEMENT_GROUP_STEP, IS_FUNCTION_STEP, 'Test Case Step' as GRID_NAME, 'Test Case View Navigation Step' AS NAVIGATION_GRID_NAME, 'TEST_CASE_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'TEST_CASE_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'TEST_CASE_STEP_UUID' as PRIMARY_COLUMN_NAME, 'TEST_CASE_STEP' as NEW_STEP_TYPE, TEST_CASE_STEP_UUID as PRIMARY_COLUMN_VALUE FROM TEST_CASE_STEP WHERE FUNCTIONAL_AREA_UUID=:APP_LOGGED_IN_FUNTIONAL_AREA_ID and TEST_CASE_UUID=:TEST_CASE_UUID AND TEST_CASE_STEP_SEQ_ID>=:START_STEP order by TEST_CASE_STEP_SEQ_ID asc`;
        queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
        queryListMap.push(testCaseStepNormalQueryObject([...new Set(queryData.map((item) => item.PRIMARY_COLUMN_VALUE).filter(isValidUUID))].map((uuid) => `'${uuid}'`).join(', ')));
  ...
  if (queryData && queryData.length) {
    ...
    for (let data of queryData) {
      if (data && Object.keys(data).length) {
        ...
        const stepTypeObj = {
          FUNCTION_STEP: { seqIdField: 'FUNCTION_STEP_SEQ_ID', idField: 'FUNCTION_STEP_SEQ_ID', typeField: 'FUNCTION_STEP_TYPE' },
          VIEW_NAVIGATION_STEP: { seqIdField: 'VIEW_NAVIGATION_STEP_SEQ_ID', idField: 'VIEW_NAVIGATION_STEP_SEQ_ID', typeField: 'VIEW_NAVIGATION_STEP_TYPE' },
          UI_ELEMENT_GROUP_STEP: { seqIdField: 'UI_ELEMENT_GROUP_STEP_SEQ_ID', idField: 'UI_ELEMENT_GROUP_STEP_SEQ_ID', typeField: 'STEP_TYPE' },
          TEST_CASE_STEP: { seqIdField: 'TEST_CASE_STEP_SEQ_ID', idField: 'TEST_CASE_STEP_SEQ_ID', typeField: 'TEST_CASE_STEP_TYPE' }
        };
        data['ATTRIBUTE_KEYS'] = stepDefTemplateVerbiageName;
        let stepType = data['NEW_STEP_TYPE'];
        if (stepType && stepTypeObj[stepType]) {
          const config = stepTypeObj[stepType];
          const optn = {
            label: `${data[config.seqIdField]} - ${data[config.typeField]} ${stepDefTemplateVerbiageName}`,
            NAME: `${data[config.seqIdField]} - ${data[config.typeField]} ${stepDefTemplateVerbiageName}`,
