...
async function fetchStepDefinitionTemplateVerbiage() {
    ...
    if (stepDefAttributeQueryData && stepDefAttributeQueryData.length) {
        ...
        const stepDefQuery = `SELECT STEP_DEFINITION_TEMPLATE_VERBIAGE_NAME FROM STEP_DEFINITION_TEMPLATE_VERBIAGE where STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID=:STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID`;
...
function getDataFromAttributeValue(attributeValueQueryData, stepDefArrributeId) {
    ...
    if (result && result.length) {
        return result[0]['VIEW_NAVIGATION_STEP_ATTRIBUTE_DATA'];
    } else {
        return '';
    }
}
...
function getUIElementData(stepDefAttributeQueryData, testCaseStepAttributeValueQueryData) {
    ...
    if (getUIElementIdFromAttribute && getUIElementIdFromAttribute.length) {
        actualUIElementUUID = getUIElementIdFromAttribute[0]['VIEW_NAVIGATION_STEP_ATTRIBUTE_DATA'];
    }
...
function getColumnHeaderData(stepDefAttributeQueryData, testCaseStepAttributeValueQueryData) {
    ...
    if (getUIElementIdFromAttribute && getUIElementIdFromAttribute.length) {
        actualColumnHeaderUUID = getUIElementIdFromAttribute[0]['VIEW_NAVIGATION_STEP_ATTRIBUTE_DATA'];
    }
...
if (input[0]['isInitialRecord'] && !input[0]['VIEW_NAVIGATION_STEP_UUID']) {
    input[0]['VIEW_NAVIGATION_STEP_TYPE'] = 'Given';
    ...
    input[0]['VIEW_NAVIGATION_STEP_TYPE'] = input[0]['VIEW_NAVIGATION_STEP_TYPE'] ? input[0]['VIEW_NAVIGATION_STEP_TYPE'] : 'When';
        ...
        for (let codeDesc of stepDefAttributeQueryData) {
            ...
            switch (codeDesc['STEP_DEFINITION_ATTRIBUTE_MASTER_UUID']) {
                case '57b76ab3-8112-4343-af0f-49643c808bf7':
                    //  input[0]['CURRENT_PAGE_CONTEXT'] = !input[0]['CURRENT_PAGE_CONTEXT'] ? getDataFromAttributeValue(testCaseStepAttributeValueQueryData, codeDesc['STEP_DEFINITION_ATTRIBUTE_UUID']) : input[0]['CURRENT_PAGE_CONTEXT'];
                    input[0]['IS_PAGE_EXIST_FOR_STEP_DEFINITION'] = 'Yes';
                    break;
...
if (input[0]['testSetScopeCodeDesc'] == '7c7a43c8-e484-11ef-904e-02c8cad0208d' || (input[0]['VIEW_NAVIGATION_STEP_UUID'])) {
...
if (input[0]['testCaseScopeCodeDesc'] == '842981e7-e484-11ef-904e-02c8cad0208d' || (input[0]['VIEW_NAVIGATION_STEP_UUID'])) {
...
if (input[0]['timeIntervalCodeDesc'] == 'e0568059-ce39-4a69-aadd-6a0dccba696d' || (input[0]['VIEW_NAVIGATION_STEP_UUID'])) {
...
if (input[0]['attemptsCodeDesc'] == '9d27f361-ac8b-4673-82fe-66c40b2cb634' || (input[0]['VIEW_NAVIGATION_STEP_UUID'])) {
    if (input[0]['ATTEMPTS']) {
...
if (input[0]['columnHeaderCodeDesc'] == 'd797acb4-5e5c-447b-b0c5-60dad38e39a5' || (input[0]['VIEW_NAVIGATION_STEP_UUID'])) {
...
if (input[0]['cellValueCodeDesc'] == '75b16425-1531-4cee-8c09-30f5be70c4b0' || (input[0]['VIEW_NAVIGATION_STEP_UUID'])) {
...
if (input[0]['rowNumberCodeDesc'] == 'ed2ebd4b-9267-4e41-8f56-d5a61abe7ba5' || (input[0]['VIEW_NAVIGATION_STEP_UUID'])) {
...
if (input[0]['tableNameCodeDesc'] == 'd25a4d7f-5c5d-4117-b325-1c669b9a42ab' || (input[0]['VIEW_NAVIGATION_STEP_UUID'])) {
...
if (input[0]['columnHeader1CodeDesc'] == '078e6534-f38f-4aad-b89d-cad8216ad86b' || (input[0]['VIEW_NAVIGATION_STEP_UUID'])) {
...
if (input[0]['cellValue1CodeDesc'] == 'ba1ef281-412a-4544-b615-7767b06eb489' || (input[0]['VIEW_NAVIGATION_STEP_UUID'])) {
...
if (input[0]['columnNumberCodeDesc'] == 'f7b6ba5d-74a7-4d36-82cd-222d57b2ce83' || (input[0]['VIEW_NAVIGATION_STEP_UUID'])) {
...
if (input[0]['fileFullPathCodeDesc'] == '28058e26-fa09-42fb-868a-1988bd0a746c' || (input[0]['VIEW_NAVIGATION_STEP_UUID'])) {
