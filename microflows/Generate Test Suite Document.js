...
try {
  msg.payload.result = {};
  msg.payload.result.documentName = msg.payload.apiRequestBody.baseEntity.records[0].TEST_SUITE_NAME
    ? msg.payload.apiRequestBody.baseEntity.records[0].TEST_SUITE_NAME.replaceAll(' ', '_')
    : 'GeneratedTestSuite';
