try {
  ...
  if (input && input.FIRST_GRID == 'TEST_CASE_STEP_TAB') {
    ...
    const selectQuery = `SELECT FUNCTION_UI_ELEMENT_GROUP_STEP_UUID, FUNCTION_UI_ELEMENT_GROUP_STEP_ID, FUNCTION_UI_ELEMENT_GROUP_STEP_SEQ_ID,FUNCTION_UI_ELEMENT_GROUP_STEP_NAME, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, CURRENT_PAGE_CONTEXT, FUNCTION_UI_ELEMENT_GROUP_STEP_TYPE, FUNCTION_STEP_UUID, FUNCTION_UUID, UI_ELEMENT_GROUP_UUID, FUNCTIONAL_AREA_UUID, 'FUNCTION_UI_ELEMENT_GROUP_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'FUNCTION_UI_ELEMENT_GROUP_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'FUNCTION_UI_ELEMENT_GROUP_STEP_UUID' as PRIMARY_COLUMN_NAME, FUNCTION_UI_ELEMENT_GROUP_STEP_UUID as PRIMARY_COLUMN_VALUE, CURRENT_PAGE_CONTEXT as PAGE_NAME FROM FUNCTION_UI_ELEMENT_GROUP_STEP WHERE FUNCTION_STEP_UUID=:FUNCTION_STEP_UUID and FUNCTIONAL_AREA_UUID=:APP_LOGGED_IN_FUNTIONAL_AREA_ID ORDER BY FUNCTION_UI_ELEMENT_GROUP_STEP_SEQ_ID asc`;
    queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
  } else if (input && input.GRID_NAME == 'Test Case Step' && input.IS_UI_ELEMENT_GROUP_STEP == 'No' && input.IS_FUNCTION_STEP == 'Yes') {
    const selectQuery = `SELECT VIEW_UUID, CURRENT_PAGE_CONTEXT as PAGE_NAME, FUNCTION_STEP_UUID, FUNCTION_STEP_ID, FUNCTION_STEP_NAME, IS_PURE_NAVIGATION_STEP, STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID, CURRENT_PAGE_CONTEXT, NEXT_PAGE_CONTEXT, FUNCTION_STEP_TYPE, FUNCTION_STEP_SEQ_ID, AE_INSERT_ID, AE_UPDATE_ID, AE_TRANSACTION_ID, AE_INSERT_TS, AE_UPDATE_TS, FUNCTIONAL_AREA_UUID, FUNCTION_UUID, FUNCTION_STEP_UUID, IS_UI_ELEMENT_GROUP_STEP, 'FUNCTION_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'FUNCTION_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'FUNCTION_STEP_UUID' as PRIMARY_COLUMN_NAME, FUNCTION_STEP_UUID as PRIMARY_COLUMN_VALUE, 'Test Case Function Step' as GRID_NAME, 'Test Case Function View Navigation Step' AS NAVIGATION_GRID_NAME FROM FUNCTION_STEP WHERE FUNCTION_UUID=:FUNCTION_UUID and FUNCTIONAL_AREA_UUID=:APP_LOGGED_IN_FUNTIONAL_AREA_ID order by FUNCTION_STEP_SEQ_ID asc`;
    queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
  } else if (input && input.GRID_NAME == 'Test Case Function Step') {
    const selectQuery = `SELECT TEST_CASE_FUNCTION_UI_ELEMENT_GROUP_STEP_UUID,TEST_CASE_FUNCTION_UI_ELEMENT_GROUP_STEP_SEQ_ID,TEST_CASE_FUNCTION_UI_ELEMENT_GROUP_STEP_ID, TEST_CASE_FUNCTION_UI_ELEMENT_GROUP_STEP_NAME, CURRENT_PAGE_CONTEXT as PAGE_NAME, 'TEST_CASE_FUNCTION_UI_ELEMENT_GROUP_STEP_ATTRIBUTE_VALUE' as CHILD_ATTRIBUTE_TABLE_NAME, 'TEST_CASE_FUNCTION_UI_ELEMENT_GROUP_STEP_ATTRIBUTE_DATA' as CHILD_ATTRIBUTE_DATA, 'TEST_CASE_FUNCTION_UI_ELEMENT_GROUP_STEP_UUID' as PRIMARY_COLUMN_NAME, TEST_CASE_FUNCTION_UI_ELEMENT_GROUP_STEP_UUID as PRIMARY_COLUMN_VALUE, TEST_CASE_FUNCTION_UI_ELEMENT_GROUP_STEP_TYPE,STEP_DEFINITION_TEMPLATE_VERBIAGE_UUID FROM TEST_CASE_FUNCTION_UI_ELEMENT_GROUP_STEP where TEST_CASE_FUNCTION_STEP_UUID=:TEST_CASE_FUNCTION_STEP_UUID and FUNCTIONAL_AREA_UUID=:APP_LOGGED_IN_FUNTIONAL_AREA_ID ORDER BY TEST_CASE_FUNCTION_UI_ELEMENT_GROUP_STEP_SEQ_ID asc`;
    queryData = await serviceOrchestrator.selectRecordsUsingQuery(`PRIMARYSPRINGFM`, selectQuery, input);
        ...
        for (let codeDesc of stepDefAttributeQueryData) {
          switch (codeDesc['STEP_DEFINITION_ATTRIBUTE_MASTER_UUID']) {
            ...
            case '74da67d2-41c9-4cf7-9eea-715243e5fcdc':
              {
                let uiElementValue = '';
                uiElementValue = getDataFromAttributeValue(attributeValueQueryData, codeDesc['STEP_DEFINITION_ATTRIBUTE_UUID'], data['CHILD_ATTRIBUTE_DATA']);
