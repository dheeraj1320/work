// console.log('input :::::::::::::::::::: 111111',input);

if (input.compositeEntityAction == 'Insert') {
  let viewId = uuid();
  input['VIEW_UUID'] = viewId;
  let viewNavigationList = [];
  let object = {
    VIEW_NAVIGATION_NAME: 'Default Navigation',
    IS_DEFAULT_NAVIGATION: 'Yes',
    VIEW_UUID: viewId,
  };
  viewNavigationList.push(object);
  input['AppEngChildEntity:VIEW_NAVIGATION'] = viewNavigationList;
  ...
  if (input.compositeEntityAction == 'Update') {
    ...
    if (input['DIRECT_ACCESS_URL']) {
      ...
      console.log('DAURL TEST CASE STEP ', TestCaseStep);
      ...
      console.log('DAURL TEST CASE FUNCTION STEP ', TestCaseFunctionStep);
      ...
      console.log('DAURL FUNCTION STEP ', FunctionStep);
